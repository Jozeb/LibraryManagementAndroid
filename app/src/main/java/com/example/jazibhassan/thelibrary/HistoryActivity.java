...
public class HistoryActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        historyClassArrayList = database.get_hist_data();
    ...
    class HistoryAdapter extends BaseAdapter {
        ...
        public View getView(int position, View view, ViewGroup viewGroup) {
            ...
            TextView return_date = (TextView) r.findViewById(R.id.return_date);
            ...
            return_date.setText(list.get(position).returndate);
            return r;
        }
    }
    ...
    class HistoryTask extends AsyncTask<String, Void, Boolean> {
        ...
        protected Boolean doInBackground(String... params) {
            String sign_url = MainActivity.IP + "library/get_history.php";
        ...
        private boolean SetUpList(String data) {
            ...
            if (columns.length > 0) {
                ...
                for (String column : columns) {
                    ...
                    if (row.length == 5) {
                        historyClassArrayList.add(new HistoryClass(row[0], row[1], row[2], row[3], row[4]));
                    } else {
                        historyClassArrayList.add(new HistoryClass(row[0], row[1], row[2], row[3], "Null"));
                    }
        ...
        protected void onPostExecute(Boolean s) {
            ...
            if (s) {
                ...
                database.put_hist_data(historyClassArrayList);
                listView.setAdapter(new HistoryAdapter(historyClassArrayList));
